...
class Book(Base):
    ...
    author_id = Column(UUID(as_uuid=True), ForeignKey("authors.author_id"), immutable=True)
    publisher_id = Column(UUID(as_uuid=True), ForeignKey("publishers.publisher_id"), immutable=True)
